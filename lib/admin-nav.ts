...
export const adminNavSections: AdminNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Testimonials", href: "/admin/testimonials", description: "Approve member testimonials.", permission: "admin:testimonials" },
...
export const adminStaticRoutes: Array<Omit<AdminNavItem, "description">> = [
  ...
  { label: "Testimonials", href: "/admin/testimonials", permission: "admin:testimonials" },
  ...
  { label: "Hero slides", href: "/admin/hero", permission: "admin:hero" },
